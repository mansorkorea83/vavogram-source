...
.field private static final aSH:Ljava/util/List;
...
.field private static final aSI:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final aSK:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final aSL:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field static final afS:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
# instance fields
.field private final aSM:Lcom/google/firebase/FirebaseOptions;

.field private final aSN:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private final aSO:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private final aSP:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final aSQ:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private aSS:Lcom/google/android/gms/internal/zzanb;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aSH:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aSI:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aSJ:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aSK:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptySet()Ljava/util/Set;

    move-result-object v0

    sput-object v0, Lcom/google/firebase/FirebaseApp;->aSL:Ljava/util/Set;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzaok:Ljava/lang/Object;

    new-instance v0, Landroid/support/v4/util/ArrayMap;

    invoke-direct {v0}, Landroid/support/v4/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/google/firebase/FirebaseApp;->afS:Ljava/util/Map;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSN:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSO:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSP:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSQ:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSR:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzask:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSM:Lcom/google/firebase/FirebaseOptions;
...
.method public static getApps(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->zzaok:Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/firebase/FirebaseApp;->afS:Ljava/util/Map;
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzana;->N()Lcom/google/android/gms/internal/zzana;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzana;->O()Ljava/util/Set;

    move-result-object v0

    sget-object v4, Lcom/google/firebase/FirebaseApp;->afS:Ljava/util/Map;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzana;->zzua(Ljava/lang/String;)Lcom/google/firebase/FirebaseOptions;
...
.method public static getInstance()Lcom/google/firebase/FirebaseApp;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzaok:Ljava/lang/Object;
...
.method public static getInstance(Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {p0}, Lcom/google/firebase/FirebaseApp;->zzrr(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/google/android/gms/common/internal/zzz;->zzhy(Ljava/lang/String;)Lcom/google/android/gms/common/internal/zzz;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/google/android/gms/common/internal/zzz;->zza(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static initializeApp(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {p0}, Lcom/google/firebase/FirebaseApp;->zzep(Landroid/content/Context;)V

    invoke-static {p2}, Lcom/google/firebase/FirebaseApp;->zzrr(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    sget-object v3, Lcom/google/firebase/FirebaseApp;->zzaok:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzana;->zzg(Lcom/google/firebase/FirebaseApp;)V

    const-class v1, Lcom/google/firebase/FirebaseApp;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->aSH:Ljava/util/List;
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aSI:Ljava/util/List;
    ...
    sget-object v3, Lcom/google/firebase/FirebaseApp;->aSJ:Ljava/util/List;
...
.method private zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzask:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/firebase/FirebaseApp;->zzask:Landroid/content/Context;

    invoke-static {v1}, Lcom/google/firebase/FirebaseApp$zzc;->zzer(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aSK:Ljava/util/List;
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aSL:Ljava/util/Set;
...
.method static synthetic zzcgw()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/firebase/FirebaseApp;->zzaok:Ljava/lang/Object;
...
.method private zzcnt()V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSO:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private zzcnx()V
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->aSH:Ljava/util/List;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->aSI:Ljava/util/List;
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aSJ:Ljava/util/List;
...
.method public static zzcp(Z)V
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->afS:Ljava/util/Map;
    ...
    iget-object v3, v0, Lcom/google/firebase/FirebaseApp;->aSN:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0}, Lcom/google/firebase/FirebaseApp;->zzcq(Z)V
...
.method private zzcq(Z)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSQ:Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zzb;->zzcp(Z)V
...
.method private static zzep(Landroid/content/Context;)V
    .locals 1
...
.method private static zzrr(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .parameter
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public getOptions()Lcom/google/firebase/FirebaseOptions;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSM:Lcom/google/firebase/FirebaseOptions;
...
.method public getToken(Z)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSS:Lcom/google/android/gms/internal/zzanb;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/internal/zzanb;->zzcr(Z)Lcom/google/android/gms/tasks/Task;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/firebase/FirebaseApp;->aSM:Lcom/google/firebase/FirebaseOptions;
...
.method public zza(Lcom/google/android/gms/internal/zzanb;)V
    .locals 1
    .parameter
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSS:Lcom/google/android/gms/internal/zzanb;
...
.method public zza(Lcom/google/android/gms/internal/zzanc;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSP:Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zza;->zzb(Lcom/google/android/gms/internal/zzanc;)V
...
.method public zza(Lcom/google/firebase/FirebaseApp$zzb;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aSN:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzamz;->L()Lcom/google/android/gms/internal/zzamz;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzamz;->M()Z
    ...
    invoke-interface {p1, v0}, Lcom/google/firebase/FirebaseApp$zzb;->zzcp(Z)V
