...
.method private traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1, v4, v3, v5}, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->applyStyleToOutput(Ljava/util/Map;Landroid/text/SpannableStringBuilder;II)V
    ...
    invoke-direct {v4, p1, p2}, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->traverseForStyle(Ljava/util/Map;Ljava/util/Map;)V
...
.method private traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;

    invoke-virtual {v1}, Ljava/util/HashMap;->clear()V

    iget-object v1, p0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
    ...
    :cond_0
    iget-boolean v1, p0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->isTextNode:Z
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->text:Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->tag:Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->getChild(I)Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;
    ...
    invoke-static {v1}, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlRenderUtil;->endParagraph(Landroid/text/SpannableStringBuilder;)V
...
.method public getCues(JLjava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    check-cast v19, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlRegion;
    ...
    iget v13, v0, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlRegion;->lineType:I
...
.method public getEventTimesUs()[J
    ...
    invoke-direct {p0, v0, v6}, Lorg/telegram/messenger/exoplayer/text/ttml/TtmlNode;->getEventTimes(Ljava/util/TreeSet;Z)V
